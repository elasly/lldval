...
public class readHdisk {

  public static void main(String... aArgs) throws IOException {
    readHdisk parser = new readHdisk("ddrsap02");
...
//    System.out.println(String.valueOf(lpar.getLparName()+" : "+lpar.getLparID()+" : "+lpar.getHostname()+" : "+lpar.getEntCapacity()));
  ...
  */
  public readHdisk(String lparName){
      String aFileName = "./Systems/"+lparName+"/storage/lscfg_disk.txt";
...
while(!nextline.startsWith("  hdisk")){scanner.nextLine();}
FileWriter out = new FileWriter("./hdisk_Details.csv",true);
         out.write("Lpar Name,Controler Serial no., LUN ID, Hdisk Name, VG Name\n");
         out.close();
while (scanner.hasNext()){
String hdiskLine = scanner.nextLine();
if (!hdiskLine.startsWith("  hdisk")){break;}
String[] hdisk  = split(hdiskLine , " ");
